...
namespace QR2Web
{
	...
	static class Language
    {
		...
		static private void FillDictionary()
		{
			...
			AddText("Options", new string[] { "Options", "Optionen", "Opzioni" });
			...
			AddText("Option7_1", new string[] { "Forward location to webpage after scan", "Nach dem Scan, Position an Webseite mitteilen", "Inoltrare la posizione alla pagina web dopo la scansione" });
			AddText("OptionChange_1", new string[] { "Change options", "Optionen ändern", "Modifica opzioni" });
			AddText("OptionChange_2", new string[] { "Do you want change:", "Möchtest du folgende Parameter:", "Vuoi modificare i parametri:" });
			AddText("OptionChange_3", new string[] { "on this app?", "in der App ändern?", "di quest'app?" });
